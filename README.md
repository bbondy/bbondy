...
- [Brave Dev Bot](https://github.com/brave-experiments/brave-dev-bot): Autonomous coding agent for Brave projects that implements PRDs, runs tests, creates PRs, and manages CI.
- [Guardrails](https://github.com/bbondy/guardrails): Native Rust CLI wrapper that blocks unsafe or prompt-injection styl...
- [Hutter Prize Workspace](https://github.com/bbondy/hutter): Rust workspace for experimenting toward a future Hutter Prize submission, with small experimental codecs including adaptive Huffman, naive LZ77, and PPM variants.
